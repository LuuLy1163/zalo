...
const ChatDetail = ({ selectedChat, onBackToChatList, conversationId, socket }) => {
    ...
    useEffect(() => {
        if (!selectedChat || !currentUser || !socket?.emit || !conversationId) return;
        ...
        const handleJoinRoom = (data) => {
            ...
            console.log("Đã tham gia room:", data.conversationId);
    ...
    }, [selectedChat, currentUser, socket, conversationId]); // Lắng nghe thay đổi của conversationId và socket
